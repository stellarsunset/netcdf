...
class SchemaBindingTest {
  ...
  void testByteDimensionVariable() {
    ...
    SchemaBinding<String> binding =
        SchemaBinding.<String>builder()
            .recordInitializer(() -> "")
    ...
    assertAll(
        ...
        () ->
            assertInstanceOf(
                FieldBinding.Byte.class,
                binding.dimensionVariableBinding("var"),
                "Should be a Byte binding"));
  }
  ...
  void testCharacterDimensionVariable() {
    ...
    assertAll(
        ...
        () ->
            assertInstanceOf(
                FieldBinding.Char.class,
                binding.dimensionVariableBinding("var"),
                "Should be a Char binding"));
  }
  ...
  void testBooleanDimensionVariable() {
    ...
    assertAll(
        ...
        () ->
            assertInstanceOf(
                FieldBinding.Bool.class,
                binding.dimensionVariableBinding("var"),
                "Should be a Bool binding"));
  }
  ...
  void testShortDimensionVariable() {
    ...
    assertAll(
        ...
        () ->
            assertInstanceOf(
                FieldBinding.Short.class,
                binding.dimensionVariableBinding("var"),
                "Should be a Short binding"));
  }
  ...
  void testIntDimensionVariable() {
    ...
    assertAll(
        ...
        () ->
            assertInstanceOf(
                FieldBinding.Int.class,
                binding.dimensionVariableBinding("var"),
                "Should be a Int binding"));
  }
  ...
  void testLongDimensionVariable() {
    ...
    assertAll(
        ...
        () ->
            assertInstanceOf(
                FieldBinding.Long.class,
                binding.dimensionVariableBinding("var"),
                "Should be a Long binding"));
  }
  ...
  void testFloatDimensionVariable() {
    ...
    assertAll(
        ...
        () ->
            assertInstanceOf(
                FieldBinding.Float.class,
                binding.dimensionVariableBinding("var"),
                "Should be a Float binding"));
  }
  ...
  void testDoubleDimensionVariable() {
    ...
    assertAll(
        ...
        () ->
            assertInstanceOf(
                FieldBinding.Double.class,
                binding.dimensionVariableBinding("var"),
                "Should be a Double binding"));
  }
  ...
  void testByteCoordinateVariable() {
    ...
    assertInstanceOf(
        FieldBinding.Byte.class,
        binding.coordinateVariableBinding("var"),
        "Should be a Byte binding");
  }
