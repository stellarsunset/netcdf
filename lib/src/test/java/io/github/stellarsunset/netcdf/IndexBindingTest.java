...
class IndexBindingTest {
  ...
  @Test
  void testD2() {
    IndexBinding.D2<Ints> binding =
        IndexBinding.D2.compose(List.of((o, i, j) -> o.addInt(i).addInt(j)));
    Ints ints = Ints.mutable();
  ...
  @Test
  void testD3() {
    IndexBinding.D3<Ints> binding =
        IndexBinding.D3.compose(List.of((o, i, j, k) -> o.addInt(i).addInt(j).addInt(k)));
    Ints ints = Ints.mutable();
  ...
  @Test
  void testD4() {
    IndexBinding.D4<Ints> binding =
        IndexBinding.D4.compose(
            List.of((o, i, j, k, u) -> o.addInt(i).addInt(j).addInt(k).addInt(u)));
    Ints ints = Ints.mutable();
