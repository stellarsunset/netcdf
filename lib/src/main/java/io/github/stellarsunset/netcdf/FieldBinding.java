...
/**
 * Super-interface for the various primitive-specific setter instances, allows for easy
 * switch-by-type handling to wrap them in type-specialized handlers.
 *
 * <p>Using {@link Consumer} or anything with a generic type forces boxing and unboxing of primitive
 * values on read and incurs significant overhead given the high gridded-data density in a normal
 * NetCDF file.
 */
